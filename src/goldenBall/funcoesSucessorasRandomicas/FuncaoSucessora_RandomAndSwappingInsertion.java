...
public class FuncaoSucessora_RandomAndSwappingInsertion extends FuncaoSucessoraRandomica{
	...
	public ArrayList<Desenvolvedor> criarSucessor(ArrayList<Desenvolvedor> estado, double custo, double confianca) {
		if(new Double(Math.random() * 1).doubleValue() <= 0.5){
			...
			return new FuncaoSucessora_Swapping().criarSucessor(estado, custo,confianca);
		}
	}
